...
public class FieldIsNegative extends FieldValidation {

    public FieldIsNegative(Object rootObject, String fieldName, Object fieldValueToValidate) {
    ...
    protected String getMessage() {
        return "Must be negative (lower than zero)";
    }
}
